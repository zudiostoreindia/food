        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <Link href="/" className="flex items-center mb-4">
              <span className="text-2xl font-bold text-red-500">Food<span className="text-orange-400">Order</span></span>
            </Link>
            <p className="text-gray-400 mb-4">
              Delicious food delivered to your doorstep. Order online for delivery, takeout, or dine-in.
            </p>
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/offers" className="text-gray-400 hover:text-white transition-colors duration-200">
                  Special Offers
                </Link>
              </li>
              <li>
          ...
          >
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400">info@foodorder.com</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 text-red-500 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
